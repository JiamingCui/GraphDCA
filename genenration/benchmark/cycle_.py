...
from gen_random_graph import create_random_graph,create_nocycle_graph
    ...
    for i in range(len(config["min_nodes"])):
        ...
        while 1:
            if flag == 0:
                ...
                random_graph = create_nocycle_graph(min_nodes, max_nodes, max_edges, min_ratio, max_ratio, weight, directed)
